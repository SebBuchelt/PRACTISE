...
%       plot photograph and hold on for visual investigation of the optimisation
        ...
        axes1 = axes('FontSize', 15.91, 'FontWeight', 'demi', ...%'Layer', 'top',...  %????? is that needed for Matlab
...
%           plot blue band (DN frequency) histogram 
            ...
            axes1 = axes('FontSize', 15.76, 'FontWeight', 'demi', ...%'Layer', 'top',...  %????? is that needed for Matlab
...
%       plot photograph, classification (projection) and GCP
        ...
        elseif cs==1 
            set(figure4, 'NumberTitle', 'off', 'Name', 'Automatic blue band snow cover classification');
        elseif cs==2 
