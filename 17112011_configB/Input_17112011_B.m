...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Name:       Input_17112011_B
%   Purpose:    Input m-file of PRACTISE (Example configuration B) 
...
fin_demW='..\17112011_configB\dem_10m_noise.txt.dem.LINK';
%       folder
fin_folder='..\17112011_configB\';
...
%               NDSI map (Arc/Info ASCII Grid) if rs==2 
    fin_satfolder_image='data\';
    if rs==2                                                               %KEEP
        fin_satname_ndsi='XYZ_NDSI.asc';
    end                                                                    %KEEP
%               unzipped raw Landsat look image for visualisation  
    fin_satfolder_look='look\'; % uncomment/comment in case
%       (cloud) mask
    if rsms>0                                                              %KEEP
%           subfolder of fin_satfolder
        fin_satfolder_mask='fmask_3_3_0_95\';
        if rsms==1                                                         %KEEP
